...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, setCookie, getResponseStatusText } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///C:/Users/Rinat/Downloads/vue-admin-2/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///C:/Users/Rinat/Downloads/vue-admin-2/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { eq, count } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/drizzle-orm/index.js';
import Database from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/better-sqlite3/lib/index.js';
import { drizzle } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/drizzle-orm/better-sqlite3/index.js';
import { sqliteTable, integer, text } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/drizzle-orm/sqlite-core/index.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unhead/dist/server.mjs';
import { isVNode, isRef, toValue } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/vue/index.mjs';
import { DeprecationsPlugin } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unhead/dist/plugins.mjs';
import { klona } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/scule/dist/index.mjs';
import { defineDiagnostics, createConsoleReporter } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/nostics/dist/formatters/ansi.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/vue/server-renderer/index.mjs';
import { stringify, uneval } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/devalue/index.js';
import { createHooks } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/errx/dist/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/Rinat/Downloads/vue-admin-2/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/Rinat/Downloads/vue-admin-2/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Rinat/Downloads/vue-admin-2","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Rinat/Downloads/vue-admin-2/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Rinat/Downloads/vue-admin-2/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Rinat/Downloads/vue-admin-2/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Rinat/Downloads/vue-admin-2/.data/kv"}));
...
const rootDir = "C:/Users/Rinat/Downloads/vue-admin-2";
...
const _Y_YLXB = eventHandler((event) => {
...
const _lazy_f83fJ4 = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_lw3g_d = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_m5xMTx = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_huT7Ww = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_dITokl = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_vbkXxO = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _Y_YLXB, lazy: false, middleware: true, method: undefined },
  { route: '/api/admin/categories/:id', handler: _lazy_f83fJ4, lazy: true, middleware: false, method: "delete" },
  { route: '/api/admin/categories/:id', handler: _lazy_lw3g_d, lazy: true, middleware: false, method: "put" },
  { route: '/api/admin/categories', handler: _lazy_m5xMTx, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/categories', handler: _lazy_huT7Ww, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/login', handler: _lazy_dITokl, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_vbkXxO, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_vbkXxO, lazy: true, middleware: false, method: undefined }
];
...
const index_get = defineEventHandler(async () => {
  ...
  }).from(categories).leftJoin(products, eq(products.categoryId, categories.id)).groupBy(categories.id).all();
});
